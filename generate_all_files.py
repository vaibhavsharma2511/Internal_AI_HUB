...
productFiles = ['generatedFiles/products-coho.csv', 'generatedFiles/products-foodrepublic.csv',
                'generatedFiles/products-goodbowl.csv', 'generatedFiles/products-memphis.csv']
outputFiles = ['generatedFiles/matrix-coho.csv', 'generatedFiles/matrix-foodrepublic.csv',
               'generatedFiles/matrix-goodbowl.csv', 'generatedFiles/matrix-memphis.csv']
cooccuranceFiles = ['generatedFiles/cooccurance-coho.csv', 'generatedFiles/cooccurance-foodrepublic.csv',
                    'generatedFiles/cooccurance-goodbowl.csv', 'generatedFiles/cooccurance-memphis.csv']
...
for i, f in enumerate(inputFiles):
    with open(f, encoding='utf-8') as file:
        ...
        # Load the data from a CSV file and create cooccurance file
        df = pd.read_csv(outputFiles[i])
